...
\- For architecture-sensitive or model-shaping work, read `docs/FIP\_ARCHITECTURE.md` and `docs/FIP\_POSITIONING.md` before making changes.
...
* Default-deny SYSTEM\_META unless explicitly allowed.
